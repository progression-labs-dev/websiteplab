...
//
// Everything here is PLACEHOLDER copy so we can see the page shape before real
// assets land (founder video/letter, team quotes, JDs — gated on a filming day
// + team-interview session). This page uses NO photography by design: the brand
// imagery modes are cinematic white-on-black, mosaic+ASCII, or the LED-mosaic
// gradient — never generic stock. Media/film slots render as near-black tiles
// until real video exists. Components read only from this file.
// Voice: no em dashes; one specific claim per line; quiet confidence.

export const ANNOUNCEMENT = {
  text: 'Hiring Forward Deployed Engineers in London',
  cta: 'View open roles',
  href: '#open-roles',
} as const
...
export const CAREERS_HERO = {
  ...
  subhead:
    'A handful of senior engineers, AI-leveraged, out-shipping companies many times our size. High agency. Total ownership. No fat.',
  primaryCta: { label: 'View open roles', href: '#open-roles' },
  secondaryCta: { label: 'Read the founder’s letter', href: '#founders-letter' },
  // Quiet mono-style stat row under the hero. `count` drives the count-up.
  stats: [
    { value: '8', suffix: '', label: 'People on the team' },
    { value: '50', suffix: '+', label: 'Person orgs we out-ship' },
    { value: '3', suffix: '', label: 'Open roles' },
    { value: 'London', suffix: '', label: 'In person, hybrid' },
  ],
} as const
...
export const WHY_PL = {
  ...
  // icon keys map to geometric SVGs in IconCards.tsx
  values: [
    {
      icon: 'agency',
      title: 'High agency',
...
// Life at PL — near-black media tiles (no photos). Real film/footage drops in
// here later; for now each tile is a labelled placeholder.
  ...
  tiles: [
    {
      ...
      body: 'No layers, no hand-offs. You sit with the problem, design the solution, and ship it.',
    },
    {
      key: 'office',
      label: 'The office',
      heading: 'In person, in London.',
      body: 'A real base built for focused, high-bandwidth work, with people who want to be in the room.',
    },
    {
      key: 'city',
      label: 'The city',
      heading: 'At the centre of it.',
      body: 'London on the doorstep: clients, talent, and the wider AI scene a short walk away.',
    },
  ] as MediaTile[],
} as const

// Film suite — the ticket's biggest differentiator. Near-black tiles until real
// 60-90s clips land on the filming day. The first item leads, full-width.
...
export const FILM_SUITE = {
  ...
  clips: [
    { key: 'why-join', label: 'Founder', title: 'Why join Progression Labs', duration: '2:10' },
    { key: 'what-fde', label: 'The role', title: 'What is a Forward Deployed Engineer?', duration: '1:40' },
    { key: 'meet-team', label: 'The team', title: 'Meet the team', duration: '1:25' },
    { key: 'day-life', label: 'London', title: 'A day in the life', duration: '1:55' },
    { key: 'the-craft', label: 'The craft', title: 'How we work, end to end', duration: '2:30' },
  ] as FilmClip[],
} as const
...
// Real names/roles. Quotes + "Previously" pedigrees are ILLUSTRATIVE
// placeholders — replace after the team-interview session.
export const MEET_THE_TEAM = {
  eyebrow: 'Meet the team',
  heading: 'The minds behind the mission.',
  members: [
    { name: 'Gabor Soter', role: 'Founder & CEO', location: 'London', previously: 'Palantir', quote: 'I wanted a place where senior people are trusted with the whole problem. We built it.' },
    { name: 'Sam Bourton', role: 'Head of Product', location: 'London', previously: 'Placeholder', quote: 'The gap between idea and shipped is measured in days here, not quarters.' },
    { name: 'Endre Sagi', role: 'Head of Finance', location: 'London', previously: 'Placeholder', quote: 'Small and disciplined beats big and busy. The numbers agree.' },
    { name: 'Jon Duffy', role: 'Head of Engineering', location: 'London', previously: 'Placeholder', quote: 'Everyone here can hold the whole system in their head. That changes how you build.' },
    { name: 'Joe O’Meara', role: 'Associate', location: 'London', previously: 'Placeholder', quote: 'I’ve owned more here in months than I would have in years anywhere else.' },
    { name: 'Conrad Guest', role: 'Senior Engineer', location: 'London', previously: 'Placeholder', quote: 'AI leverage means one of us ships what used to take a team. That’s the fun part.' },
    { name: 'Chris Little', role: 'Senior Engineer', location: 'London', previously: 'Placeholder', quote: 'No politics, no busywork. Just the work and the people doing it.' },
    { name: 'Talha Muhammad', role: 'Senior Engineer', location: 'London', previously: 'Placeholder', quote: 'You stand behind what you build, in front of the client. It keeps the bar high.' },
  ] as TeamMember[],
} as const
...
export const ALUMNI = {
  ...
  // Destinations rendered as large type, not logos / photos.
  destinations: ['Anthropic', 'Arm', 'Palantir', 'Funded founders'],
  quote: {
    text: 'The two years I spent here did more for me than anywhere else I’ve worked.',
    attribution: 'Former Progression Labs engineer (placeholder)',
  },
} as const
...
export const BENEFITS = {
  ...
  items: [
    { icon: 'equity', title: 'Meaningful equity', body: 'Real ownership in what we’re building together.' },
    { icon: 'health', title: 'Health & wellness', body: 'Cover for you, plus a wellness budget.' },
    { icon: 'time', title: 'Time off that’s real', body: 'Generous, and actually taken.' },
    { icon: 'offsite', title: 'Offsites', body: 'We get the whole team together, properly.' },
    { icon: 'office', title: 'A real office', body: 'A London base built for focused, in-person work.' },
    { icon: 'learning', title: 'Learning budget', body: 'Conferences, courses, tools. We invest in you.' },
  ] as Benefit[],
} as const

export const CLOSING_CTA = {
  heading: 'Think you’re a fit?',
  body: 'If this page read like the work you’ve been looking for, you already know. Come talk to us.',
  primaryCta: { label: 'View open roles', href: '#open-roles' },
  secondaryCta: { label: 'Read the founder’s letter', href: '#founders-letter' },
} as const
